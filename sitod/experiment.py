...
class IntentClusteringExperiment(Experiment):
    def __init__(
        ...
        print(self._dialog_reader)
        print(self._dialogues_path)
        print(self._intent_clustering_model)
        print("------------------------------------------")
    ...
    def _run_experiment(
        ...
        print("data directory:",data_root_dir)
        ...
        if not (experiment_dir / OutputPaths.TURN_PREDICTIONS).exists() and not self._overwrite:
            ...
            #print(dialogues[10])
            print(len(intents_by_turn_id.keys()))
            print(len(utterances_by_turn_id.keys()))
            print("-------------------------------")
